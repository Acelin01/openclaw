...
async function executeToolDirectly(toolName: string, args: any) {
  ...
  const toolMethodMap: Record<string, { method: string; section?: string }> = {
    ...
    'milestone_list': { method: 'getMilestones' },
    'milestone_get': { method: 'getMilestoneById' },
    'milestone_update': { method: 'updateMilestone' },
    'milestone_delete': { method: 'deleteMilestone' },
    'milestone_monitor': { method: 'getMilestones' },
