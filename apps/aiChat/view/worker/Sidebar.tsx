...
export function WorkerSidebar() {
  ...
  const tabs = WORKER_SERVICE_TABS.map(tab => ({
    ...tab,
    href: `/workers${tab.href}`,
  }));
  ...
  return (
    <aside className="w-64 bg-white border-r border-zinc-200 flex flex-col z-20">
      ...
      <div className="p-5 border-b border-zinc-100 flex items-center gap-3 bg-zinc-50/50">
        ...
        <div>
          <h2 className="text-base font-black text-zinc-900 leading-none">自由工作者</h2>
          <p className="text-[10px] text-zinc-500 mt-1 uppercase tracking-wider font-bold">Worker Service</p>
        </div>
      </div>
