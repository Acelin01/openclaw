    ...
    hybridPlanning: {
        ...
        generateHybridPlan: (projectType, teamSize) => {
            ...
            return {
                ...
                riskAssessment: "Medium - Resource contention between agile dev and waterfall documentation phases",
            };
        },
    },
    /**
 ...
 */
export function createSkillMessage(senderId, recipientIds, skillName, action, parameters, projectId) {
    return {
        header: {
