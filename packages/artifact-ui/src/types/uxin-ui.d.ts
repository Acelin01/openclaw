declare module "@uxin/ui" {
  ...
  export const DropdownMenuContent: FC<
    { children?: ReactNode; className?: string; align?: string } & HTMLAttributes<HTMLDivElement>
  >;
  ...
  export const DropdownMenuCheckboxItem: FC<
    { children?: ReactNode; checked?: boolean } & HTMLAttributes<HTMLDivElement>
  >;
  export const DropdownMenuRadioItem: FC<
    { children?: ReactNode; value?: string } & HTMLAttributes<HTMLDivElement>
  >;
  ...
  export const AlertDialogAction: FC<
    { children?: ReactNode; className?: string } & HTMLAttributes<HTMLButtonElement>
  >;
  ...
  export const Progress: FC<
    { value?: number; className?: string } & HTMLAttributes<HTMLDivElement>
  >;
  ...
  export const ScrollBar: FC<
    { orientation?: "horizontal" | "vertical"; className?: string } & HTMLAttributes<HTMLDivElement>
  >;
